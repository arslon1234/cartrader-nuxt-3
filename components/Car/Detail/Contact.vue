  ...
  <div class="mt-10">
    <div class="flex flex-col w-[600px]">
      <div class="flex justify-between">
        ...
        <input type="email" v-model="message.email" class="border p-1" placeholder="Email">
      ...
      <div>
        <button :disabled="disableButton" @click="onSubmit"
          class="bg-blue-400 text-white px-10 py-3 rounded mt-4">Submit</button>
